...
INSERT INTO languages (languages_id, name, code, image, directory, sort_order) values (3, 'Francés', 'fr', 'icon.gif', 'french',2);
...
INSERT INTO languages (languages_id, name, code, image, directory, sort_order) values (4, 'Italiano', 'it', 'icon.gif', 'italiano',2);
...
INSERT INTO languages (languages_id, name, code, image, directory, sort_order) values (5, 'Portugues', 'pt', 'icon.gif', 'portugues',2);
