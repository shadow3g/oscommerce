 ...
 */
 ...
 class pagamastarde_eom {
    ...
    function pagamastarde_eom() {
      global $order;
      $this->signature = 'pagamastarde_eom|pagamastarde_eom|1.1|1.0';
